        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="custom-file">
                    <div class="col-lg-10">
                    <form:input  path="productImage" type="file" class="form:input-large" id="customFile"  />
                    </div>
                        <label class="control-label col-lg-2" for="customFile">

                        <spring:message code="addProduct.form.image.label"/>
                    </label>
                </div>
